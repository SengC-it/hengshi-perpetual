...
- V12.4 做空：2ATR 初始止损、3ATR 移动止盈、最长持有72小时。提醒中的“参考止盈点位”是入场价减3ATR，不是固定止盈单。
- V12.4 做多：1.5ATR 初始止损；4小时K线收盘达到动态EMA20后，下一根开盘退出；最长持有24小时。
- V12.7 退出影子盘复用 V12.4 的同一信号、入场价和仓位，仅把做空最长持有延长到96小时。它只用于A/B纸面研究，不改变V12.4信号或真实下单锁。
